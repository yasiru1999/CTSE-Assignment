    ...
    return (
        <View style={styles.container}>
            ...
            >
                ...
                <Text style={{marginBottom:10,marginLeft:40}}>Title: {trip.name}</Text>
                <Text style={{marginBottom:10,marginLeft:40}} >Status: {trip?.status}</Text>
                <Text style={{marginBottom:10,marginLeft:40}} >Dates: {trip?.dates}</Text>
                <Text style={{marginBottom:10,marginLeft:40}} >Budget: {trip?.budget}</Text>
